...
#ifndef __COOP_STRING_TABLE_H_
#define __COOP_STRING_TABLE_H_
...
#define TXT_WELCOME		TXT(22)	//"Welcome to the Coop %s!"
#define TXT_JOINED		TXT(23)	//"%s has joined the Coop"
#define TXT_POINTS		TXT(24)	//"Points"
#define TXT_HUDD_NONE	TXT(25)	//"Coop: HUD Display set to None"
#define TXT_HUDD_SCORES	TXT(26)	//"Coop: HUD Display set to Scores"
#define TXT_HUDD_EFFIC	TXT(27)	//"Coop: HUD Display set to Efficiency"
...
#define TXT_SAVE_HEADER		TXT(36)	//"Coop\r\nGame: %s\r\nLevel: %d\r\n"
...
#define TXT_MSG_COLORPLR	TXT(42)	//"Coop HUD Color Model: Player Colors"
#define TXT_MSG_COLORNORM	TXT(43)	//"Coop HUD Color Model: Normal"
